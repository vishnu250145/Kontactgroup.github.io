...
(function(e) {
    ...
    e.magnificPopup.registerModule(P, {
        options: {
            settings: null,
            cursor: "mfp-ajax-cur",
            tError: '<a HREF="-25url-25">The content</a> could not be loaded.'
        },
        proto: {
            initAjax: function() {
                p.types.push(P);
    ...
    e.magnificPopup.registerModule("image", {
        options: {
            ...
            titleSrc: "title",
            verticalFit: true,
            tError: '<a HREF="-25url-25">The image</a> could not be loaded.'
        },
        proto: {
            initImage: function() {
                var e = p.st.image,
    ...
    e.magnificPopup.registerModule(U, {
        options: {
            markup: '<div class="mfp-iframe-scaler">' + '<div class="mfp-close"></div>' + '<iframe class="mfp-iframe" SRC="../../../../about-3Ablank" frameborder="0" allowfullscreen></iframe>' + "</div>",
