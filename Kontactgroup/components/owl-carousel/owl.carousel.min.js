if (typeof Object.create !== "function") {
    ...
    var r = {
        ...
        updateItems: function() {
            var r = this,
                i, s;
            if (r.options.responsive === false) {
                return false
            }
            if (r.options.singleItem === true) {
                r.options.items = r.orignalItems = 1;
                r.options.itemsCustom = false;
                r.options.itemsDesktop = false;
                r.options.itemsDesktopSmall = false;
                r.options.itemsTablet = false;
                r.options.itemsTabletSmall = false;
                r.options.itemsMobile = false;
                return false
            }
            if (r.options.responsiveBaseWidth === t) {
                i = t.innerWidth || n.documentElement.clientWidth || n.body.clientWidth
            } else {
                i = e(r.options.responsiveBaseWidth).width()
            }
            if (i > (r.options.itemsDesktop[0] || r.orignalItems)) {
                r.options.items = r.orignalItems
            }
            if (r.options.itemsCustom !== false) {
                r.options.itemsCustom.sort(function(e, t) {
                    return e[0] - t[0]
                });
                for (s = 0; s < r.options.itemsCustom.length; s += 1) {
                    if (r.options.itemsCustom[s][0] <= i) {
                        r.options.items = r.options.itemsCustom[s][1]
                    }
                }
            } else {
                if (i <= r.options.itemsDesktop[0] && r.options.itemsDesktop !== false) {
                    r.options.items = r.options.itemsDesktop[1]
                }
                if (i <= r.options.itemsDesktopSmall[0] && r.options.itemsDesktopSmall !== false) {
                    r.options.items = r.options.itemsDesktopSmall[1]
                }
                if (i <= r.options.itemsTablet[0] && r.options.itemsTablet !== false) {
                    r.options.items = r.options.itemsTablet[1]
                }
                if (i <= r.options.itemsTabletSmall[0] && r.options.itemsTabletSmall !== false) {
                    r.options.items = r.options.itemsTabletSmall[1]
                }
                if (i <= r.options.itemsMobile[0] && r.options.itemsMobile !== false) {
                    r.options.items = r.options.itemsMobile[1]
                }
            }
            if (r.options.items > r.itemsAmount && r.options.itemsScaleUp === true) {
                r.options.items = r.itemsAmount
            }
        },
        response: function() {
            var n = this,
